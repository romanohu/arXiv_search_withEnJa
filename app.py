...
with st.expander("使い方"):
    st.write("これは英語でしか検索できないarXivに対して日本語で検索を試みる検索システムです．以下の手順で使用できます:" \
    "\n" \
    "1. **arXiv分野検索キーワード**: arXivで調べたい分野を「英語」で入力します．例:Machine Learning, transformerなど．" \
    "\n" \
    "2. **日本語クエリ**: 検索したいキーワードやフレーズを「日本語」で入力します．" \
    "\n" \
